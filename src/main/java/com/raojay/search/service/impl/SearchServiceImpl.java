...
import com.raojay.search.dao.ItemDao;
...
public class SearchServiceImpl implements SearchService
{
    ...
    @Override
    public SearchResult search(String queryString, Long page, Long pageSize)
        throws Exception
    {
        //创建查询对象
    ...
    public SearchResult moreIikeByItem(SolrItem item)
        throws Exception
    {
